...
const navItems = [
  ...
  { path: '/admin/live-map', label: 'Live Map', icon: Navigation, permission: STAFF_PERMISSIONS.LIVE_MAP },
  ...
  // Driver Control — manage banners and settings for drivers
  {
    label: 'Driver Control',
    icon: Monitor,
    roles: ['admin', 'sub_admin'],
    children: [
      { path: '/admin/driver-banners', label: 'Driver Banners', icon: LayoutTemplate, roles: ['admin', 'sub_admin'], permission: STAFF_PERMISSIONS.BANNERS },
      { path: '/admin/driver-faqs', label: 'Driver FAQs', icon: HelpCircle, roles: ['admin', 'sub_admin'], permission: STAFF_PERMISSIONS.SUPPORT || 'SUPPORT' },
      { path: '/admin/driver-settings', label: 'Driver Settings', icon: Settings, roles: ['admin', 'sub_admin'], permission: STAFF_PERMISSIONS.SETTINGS || 'SETTINGS' },
    ],
  },
  {
    label: 'Bookings',
  ...
  },
  {
    ...
    icon: Radio,
    roles: ['admin'],
    permission: STAFF_PERMISSIONS.BROADCAST,
  },
];
