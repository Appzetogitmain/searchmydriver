...
const ConfirmAndPayPage = () => {
  ...
  // total includes the optional tip
  const fareTotal = Number(estimate?.fareBreakdown?.totalPayable || 0);
  const tipTotal = Number(offlineTip || 0);
  const bufferRupees = Number(estimate?.waitingBuffer?.bufferRupees || 0);
  const total = Math.round((fareTotal + tipTotal + bufferRupees) * 100) / 100;
    ...
    <div className="flex-1 flex flex-col bg-bg min-h-dvh">
      ...
      <div className="flex-1 p-4 space-y-4">
        ...
        */}
        ...
        <FareCard estimate={estimate} estimating={estimating} error={estimateError} extraTip={offlineTip} />
