  ...
  return (
    <div className="flex-1 flex flex-col relative bg-gray-950 min-h-dvh overflow-hidden">
      ...
      <TripChatModal
        ...
        recipientPhone={driver?.phone_no || driver?.phone}
        recipientPhotoUrl={driverPhotoUrl}
...
function TripDetailsCard({ booking }) {
  ...
  const distance = booking.fareSnapshot?.breakdown?.distanceKm || booking.outstation?.estimatedKm;
  ...
  return (
    <Card>
      ...
      <div className="grid grid-cols-2 gap-3 mb-3">
        ...
        {distanceLabel && (
          <DetailTile
            icon={<Navigation className="w-4 h-4 text-primary-dark" />}
            label="Distance"
            value={distanceLabel}
          />
        )}
