      ...
      <div className="pt-4">
        <div className="flex items-start gap-3 mb-4">
          ...
          <button
            ...
            disabled={submitting}
            className="p-1.5 -mr-1.5 -mt-1 rounded-full hover:bg-slate-100 text-text-secondary disabled:opacity-50"
            aria-label="Close"
          >
            <X className="w-5 h-5" />
          </button>
        ...
        <div className="max-h-[44vh] overflow-y-auto -mx-1 px-1 space-y-1.5">
          {loading ? (
            ...
            filtered.map((z) => {
              ...
              const subItems = [];
              if (city) subItems.push(city);
              if (code && code.toLowerCase() !== city.toLowerCase()) subItems.push(code);
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-text-muted truncate mt-0.5">
                      {subItems.length > 0 ? subItems.join(' \u00b7 ') : 'Active zone'}
                    </p>
                  </div>
                  <div
