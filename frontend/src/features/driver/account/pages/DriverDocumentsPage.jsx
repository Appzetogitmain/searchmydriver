...
const DriverDocumentsPage = () => {
  ...
  if (driver.profilePicture) {
    documents.unshift({
      _id: 'profile_picture_id',
      type: 'profile_picture',
      fileUrl: driver.profilePicture,
      uploadedAt: driver.createdAt || new Date(),
              ...
              <Card key={doc._id || doc.type} padding="p-0" className="overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <Info label="Verified at" value={doc.verifiedAt ? formatDate(doc.verifiedAt) : 'Pending'} icon={Calendar} />
                  </div>
                </div>
              </Card>
            );
