...
const NavigateToCustomerPage = () => {
  ...
  return (
    <div className="flex-1 flex flex-col bg-bg min-h-dvh">
      ...
      <div className="flex-1 p-4 -mt-4 z-10 space-y-4">
        <Card className="animate-fade-in-up">
          ...
          <div className="flex gap-3 mb-4">
            ...
            <Button variant="secondary" size="md" className="flex-1" icon={MessageSquare} onClick={() => setChatOpen(true)}>Message</Button>
          </div>
          <div>
      ...
      <DriverChatSheet open={chatOpen} onClose={() => setChatOpen(false)} />
    </div>
  );
};
