...
export const PIN_ASSETS = Object.freeze({
  ...
  /** TOP DOWN ICONS FOR REALISTIC MOVEMENT */
  TOPDOWN_CAR: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 200"><rect x="15" y="10" width="70" height="180" rx="20" fill="%23E2E8F0" stroke="%2394A3B8" stroke-width="2"/><path d="M 22 50 L 78 50 L 85 140 L 15 140 Z" fill="%23334155"/><rect x="25" y="60" width="50" height="70" rx="5" fill="%23E2E8F0"/><rect x="5" y="60" width="10" height="20" rx="3" fill="%2394A3B8"/><rect x="85" y="60" width="10" height="20" rx="3" fill="%2394A3B8"/><rect x="20" y="10" width="15" height="5" fill="%23FEF08A"/><rect x="65" y="10" width="15" height="5" fill="%23FEF08A"/><rect x="20" y="185" width="15" height="5" fill="%23EF4444"/><rect x="65" y="185" width="15" height="5" fill="%23EF4444"/></svg>',
  TOPDOWN_MAN: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><rect x="20" y="45" width="60" height="25" rx="12" fill="%231D4ED8"/><circle cx="20" cy="35" r="10" fill="%231D4ED8"/><circle cx="80" cy="35" r="10" fill="%231D4ED8"/><circle cx="20" cy="25" r="8" fill="%23FCD34D"/><circle cx="80" cy="25" r="8" fill="%23FCD34D"/><circle cx="50" cy="40" r="22" fill="%23FCD34D"/><path d="M 28 40 A 22 22 0 0 1 72 40 Z" fill="%231E293B"/></svg>',
});
