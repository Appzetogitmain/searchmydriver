...
export const PLATFORM_REVENUE_SOURCE = Object.freeze({
  ...
  /** Admin adds funds via Razorpay/Dummy */
  WALLET_TOP_UP: 'wallet_top_up',
  /** Admin withdraws funds to bank */
  WALLET_WITHDRAWAL: 'wallet_withdrawal',
  /** Admin manually adds funds */
  MANUAL_ADD: 'manual_add',
  /** Admin manually deducts funds */
  MANUAL_DEDUCT: 'manual_deduct',
  /** Monthly Ride registration fee */
  MONTHLY_REGISTRATION: 'monthly_registration',
  /** Penalty charged to a driver for taking a trip without purchasing a kit */
...
const platformRevenueSchema = new mongoose.Schema(
  {
    ...
    /** ₹ kept by the platform (can be negative for withdrawals/deductions). */
