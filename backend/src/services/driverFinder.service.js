...
export async function findDriversWithinRadius({
  ...
  if (requirePositiveWalletBalance && minWalletBalance === null) match['wallet.balance'] = { $gte: 0 };
  if (minWalletBalance !== null) match['wallet.balance'] = { ...match['wallet.balance'], $gte: minWalletBalance };
