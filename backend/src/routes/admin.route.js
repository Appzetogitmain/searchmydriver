...
// ── Broadcasts ─────────────────────────────────────────────────────────────
router.post('/broadcast', restrictTo(...SUPER_ADMIN), sendBroadcast);
router.get('/broadcasts', restrictTo(...ALL_STAFF), getBroadcasts);
router.get('/broadcasts/stats', restrictTo(...ALL_STAFF), getBroadcastStats);
router.get('/broadcasts/search-users', restrictTo(...ALL_STAFF), searchUsers);
router.get('/broadcasts/search-drivers', restrictTo(...ALL_STAFF), searchDrivers);

router.get('/users', restrictTo(...ALL_STAFF), getCustomers);
router.patch('/users/:id/suspend', restrictTo(...ALL_STAFF), suspendUser);
router.patch('/users/:id/unsuspend', restrictTo(...ALL_STAFF), unsuspendUser);
...
router.get('/user-wallet-history', restrictTo(...ALL_STAFF), getUserWalletHistory);
router.post('/user-wallet/adjust', restrictTo(...OPERATIONS), adjustUserWallet);
...
router.put('/drivers/:id/documents', protectStaff, restrictTo(...ALL_STAFF), updateDriverDocument);
